...
public class GameModeSprint extends GameMode {
    ...
    private static final int RANK_LIMIT_SOLDIER = 200;
    private static final int RANK_LIMIT_CORPORAL = 400;
    private static final int RANK_LIMIT_SERGEANT = 600;
    private static final int RANK_LIMIT_ADMIRAL = 800;
